      ...
      <div className="container flex h-14 items-center justify-between">
        <div className="hidden md:flex flex-1 items-center">
          <Link href="/" className="mr-8 flex items-center space-x-2">
            <Image src="/logo.jpg" alt="Byte Brigade Logo" width={36} height={36} className="rounded-sm border border-matrix-green/50" />
        ...
        <div className="md:hidden flex flex-1 items-center justify-between gap-2">
          <div className="flex items-center gap-2">
            <Image src="/logo.jpg" alt="Byte Brigade Logo" width={32} height={32} className="rounded-sm border border-matrix-green/50" />
